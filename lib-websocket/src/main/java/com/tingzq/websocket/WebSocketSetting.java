...
import com.tingzq.websocket.dispatcher.DefaultResponseDispatcher;
import com.tingzq.websocket.dispatcher.IResponseDispatcher;
...
public class WebSocketSetting {
    ...
    /**
     * 设置消息发射器，不设置则默认使用 {@link MainThreadResponseDelivery}.
